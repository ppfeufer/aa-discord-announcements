# Makefile for AA Discord Announcements

# Variables
appname = aa-discord-announcements
appname_verbose = AA Discord Announcements
package = aa_discord_announcements
...
help::
	...
	@echo "    prepare-release           Prepare a release and update the version in '$(package)/__init__.py' and 'README.md' Docker install instructions."
